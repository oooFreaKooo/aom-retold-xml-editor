<template>
    <v-expansion-panel>
        ...
        <v-expansion-panel-text>
            ...
            <v-row>
                <v-col>
                    <v-btn class="mt-2 me-2" prepend-icon="mdi-content-save" color="success" :rounded="false" @click="saveAndClose">
                        Save
                    </v-btn>
                    <v-btn
                        class="mt-2 me-2"
                ...
                <v-col class="d-flex justify-end">
                    <v-btn variant="text" prepend-icon="mdi-undo" color="warning" :rounded="false" @click="undo" :disabled="!canUndo">
                        Undo
                    </v-btn>
...
<script lang="ts" setup>
    ...
    watch(
        ...
        ([newUnitTypes, newUnitFlags]) => {
            selectedItems.value = []
            let updatedItems = [...selectedItems.value]
